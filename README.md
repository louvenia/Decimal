...
Реализованы описанные [выше](#information) функции библиотеки:
...
- При реализации decimal ориентировались на [двоичное представление](#двоичное-представление) с целочисленным массивом `bits`
